...
/* harmony import */ var _mixins_StarRating_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../mixins/StarRating.js */ "./resources/js/mixins/StarRating.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixins: [_mixins_StarRating_js__WEBPACK_IMPORTED_MODULE_1__["default"]],
  data: function data() {
    return {
      value: 0
    };
  ...
  methods: {
    ...
    fill: function fill(formData) {
      console.log('nova-rating-field:', this.value);
...
/* harmony import */ var _mixins_StarRating_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../mixins/StarRating.js */ "./resources/js/mixins/StarRating.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixins: [laravel_nova__WEBPACK_IMPORTED_MODULE_0__.FormField, laravel_nova__WEBPACK_IMPORTED_MODULE_0__.HandlesValidationErrors, _mixins_StarRating_js__WEBPACK_IMPORTED_MODULE_2__["default"]],
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_PanelItem, {
    ...
    value: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_star_rating, {
        ...
        rating: parseFloat(_ctx.value) || 0,
        increment: _ctx.increment,
        "max-rating": _ctx.max,
        "show-rating": _ctx.showRating,
        "star-size": $props.field['star-size'],
        "inactive-color": $props.field['inactive-color'],
        "active-color": $props.field['active-color'],
        "border-color": $props.field['border-color'],
        "border-width": $props.field['border-width'],
        padding: $props.field['padding'],
        "rounded-corners": $props.field['rounded-corners'],
        inline: $props.field['inline'],
        glow: $props.field['glow'],
        "glow-color": $props.field['glow-color'],
        "text-class": $props.field['text-class']
      }, null, 8 /* PROPS */, ["id", "name", "rating", "increment", "max-rating", "show-rating", "star-size", "inactive-color", "active-color", "border-color", "border-width", "padding", "rounded-corners", "inline", "glow", "glow-color", "text-class"])];
    }),
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["index", "field"]);
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_star_rating, {
        "read-only": false,
        "onUpdate:rating": _ctx.setRating,
        id: $props.field.name,
        name: $props.field.name,
        rating: parseFloat(_ctx.value) || 0,
        increment: _ctx.increment,
        ...
        "glow-color": $props.field['glow-color'],
        "text-class": $props.field['text-class']
      }, null, 8 /* PROPS */, ["onUpdate:rating", "id", "name", "rating", "increment", "max-rating", "show-rating", "star-size", "inactive-color", "active-color", "border-color", "border-width", "padding", "rounded-corners", "inline", "glow", "glow-color", "text-class"])];
    }),
    _: 1 /* STABLE */
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_star_rating = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("star-rating");
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_star_rating, {
    id: $props.field.name,
    name: $props.field.name,
    rating: parseFloat(_ctx.value) || 0,
    increment: _ctx.increment,
...
Nova.booting(function (app, store) {
  app.component('index-nova-rating-field', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-nova-rating-field', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-nova-rating-field', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
  app.mixin({
    mounted: function mounted() {
      console.log('nova-rating-field:', 'mounted');
    }
...
/***/ "./resources/js/mixins/StarRating.js":
/*!*******************************************!*\
  !*** ./resources/js/mixins/StarRating.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _opt_eom_nova_components_NovaRatingField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_opt_eom_nova_components_NovaRatingField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkeom_plus_nova_rating_field"] = self["webpackChunkeom_plus_nova_rating_field"] || [];
